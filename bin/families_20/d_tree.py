...
output_file_path = '../../models_results/families_20/decision_tree_results_families.txt'
model_file_path = '../../models_results/families_20/best_decision_tree_model_families.joblib'
