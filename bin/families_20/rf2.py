...
output_file_path = '../../models_results/families_20/random_forest_results_families.txt'
model_file_path = '../../models_results/families_20/best_random_forest_model_families.joblib'
...
# n_jobs(Threads)=20
grid_search = GridSearchCV(estimator=rf_classifier, param_grid=param_grid, cv=5, verbose=3, n_jobs=20)
