...
model_file_path = '../../models_results/true_negative/svm_model_6.joblib'
evaluation_report_path = '../../models_results/true_negative/SVM_report_6.txt'
...
# n_jobs(Threads)=20
grid_search = GridSearchCV(estimator=svm_model, param_grid=param_grid, cv=5, verbose=3, n_jobs=20)
