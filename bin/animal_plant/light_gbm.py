...
output_file_path = '../../models_results/animal_plant/lgb_results.txt'
model_file_path = '../../models_results/animal_plant/lgb_model_.joblib'
...
param_grid = {
    ...
    'num_leaves': [100, 500, 1000, 2000, 3000]
}
...
# n_jobs(Threads)=20
grid_search = GridSearchCV(estimator=lgb_classifier, param_grid=param_grid, cv=5, verbose=3, n_jobs=1)
